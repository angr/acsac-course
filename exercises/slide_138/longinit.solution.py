...
# load the binary
project = angr.Project("overflow3-longinit", load_options={ 'auto_load_libs': False })
...
# now, create the simgr with that state as the initial state
...
simgr.active[0].options |= simuvex.options.unicorn
...
print('# ./overflow3-longinit "$(cat pwning_input)"')
